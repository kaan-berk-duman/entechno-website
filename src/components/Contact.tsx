        ...
        <>
            <div className="min-h-screen bg-white py-6 flex flex-col justify-center sm:py-12">
                <div className="relative py-3 sm:max-w-xl sm:mx-auto">
                    <div
                        className="absolute inset-0 bg-gradient-to-r from-blue-700 to-blue-500 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl">
                    </div>
                    <div className="text-white relative px-4 py-10 bg-blue-400 shadow-lg sm:rounded-3xl sm:p-20">

                        <div className="text-center pb-6">
                            <h1 className="text-3xl">İletişim</h1>
                            <div className="p-6 block text-white">
                                <div className="flex flex-col items-center">
                                    <p className="flex items-center mb-6">
                                        ...
                                        <h5 className="text-base font-normal leading-6 ml-5">+905398505133</h5>
                                    </p>
                                    <p className="flex items-center mb-6">
                                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <h5 className="text-base font-normal leading-6 ml-5">info@entechno.com.tr</h5>
                                    </p>
                                    <p className="flex items-center">
                                        ...
                                        <h5 className="text-base font-normal leading-6 ml-5">Bilişim Vadisi 2B 216</h5>
                                    </p>
                                </div>
                            </div>
                        ...
                        <form>
                            ...
                            <input
                                className="shadow mb-4 appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                type="text" placeholder="Konu" name="_subject" />

                            <textarea
                                className="shadow mb-4 min-h-0 appearance-none border rounded h-64 w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                placeholder="Mesaj" name="message" style={{ height: '121px' }}></textarea>
