...
export const Hero = () => {
  return (
    <div className="py-[72px] sm:py-24 relative overflow-clip">
      <div className="absolute h-[375px] w-[750px] sm:w-[1536px] sm:h-[768px] lg:w-[2400px] llg:h-[800px] rounded-[100%] left-1/2 -translate-x-1/2 border  top-[calc(100%-96px)] sm:top-[calc(100%-120px)]"></div>
    <div className="container relative">
      ...
      <h1 className='text-7xl sm:text-9xl font-bold tracking-tightner text-center inline-flex'>Entechno <br/> is more</h1>
